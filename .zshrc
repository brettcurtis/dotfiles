...
export PATH=$HOME/bin:/home/linuxbrew/.linuxbrew/lib/ruby/gems/3.0.0/bin:$PATH
...
plugins=(git terraform gcloud aws bundler docker kubectl kubectx gem helm kitchen ubuntu vault)
