# Generated by Powerlevel10k configuration wizard on 2021-12-16 at 16:04 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=004
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubectx|k9s'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=008
  ...
  typeset -g POWERLEVEL9K_TERRAFORM_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'         OTHER)
  typeset -g POWERLEVEL9K_TERRAFORM_OTHER_FOREGROUND=068
  # typeset -g POWERLEVEL9K_TERRAFORM_OTHER_VISUAL_IDENTIFIER_EXPANSION='⭐'

  #############[ terraform_version: terraform version (https://www.terraform.io) ]##############
  # Terraform version color.
  typeset -g POWERLEVEL9K_TERRAFORM_VERSION_FOREGROUND=068
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='gcloud'
   # Google cloud color.
  typeset -g POWERLEVEL9K_GCLOUD_FOREGROUND=249
